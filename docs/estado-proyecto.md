...
|---|---|---|
| 🔴 **El plan del Planner no está cargado** y el docente dijo que solo revisará el Planner. El CSV ya quedó reescrito contra el estado real (87 tareas, ninguna bloqueada); falta correr la carga y, después, adjuntar cada artefacto a su tarea | [docs/guia-cargar-planner.md](guia-cargar-planner.md) | Bloqueante |
